...
import { getUserProfile, updateUserProfile } from '../../../../services/AdminService'; // Adjust the path as needed
  ...
  useEffect(() => {
    ...
    getUserProfile()
      .then(response => {
        ...
        setValue('age', response.data.profile.age);
        setValue('gender', response.data.profile.gender);
        setValue('phone_number', response.data.profile.phone_number);
        setValue('province', response.data.profile.province);
        setValue('date_of_birth', response.data.profile.date_of_birth ? new Date(response.data.profile.date_of_birth).toISOString().substring(0, 10) : '');
        setValue('place_of_birth_village', response.data.profile.place_of_birth.village);
        setValue('place_of_birth_town', response.data.profile.place_of_birth.town);
        setValue('place_of_birth_province', response.data.profile.place_of_birth.province);
        setValue('place_of_birth_country', response.data.profile.place_of_birth.country);
      })
