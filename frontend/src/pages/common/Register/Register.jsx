...
const Register = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-800">
      <form onSubmit={handleSubmit} className="max-w-lg mx-auto p-8 bg-gray-900 shadow-xl rounded-lg border border-gray-700">
        <h2 className="text-3xl font-extrabold mb-6 text-green-500 text-center">Registration</h2>
        ...
        <div className="mb-6 flex items-center border border-gray-600 rounded-md shadow-sm bg-gray-800">
          ...
          <input
            ...
            onBlur={handleBlur}
            className="w-full px-4 py-2 bg-gray-700 text-white border-none rounded-md focus:outline-none focus:ring-2 focus:ring-green-500"
          />
        </div>
        ...
        <div className="mb-6 flex items-center border border-gray-600 rounded-md shadow-sm bg-gray-800">
          <EnvelopeIcon className="h-6 w-6 text-gray-400 ml-3" />
          <input
            id="email"
            type="email"
            value={email}
        ...
        <div className="mb-6 flex items-center border border-gray-600 rounded-md shadow-sm bg-gray-800 relative">
          <LockClosedIcon className="h-6 w-6 text-gray-400 ml-3" />
          <input
            id="password"
        ...
        {showPasswordChecker && focusedField === 'password' && (
          <div className="mb-6 mt-4 bg-gray-700 p-4 rounded-md shadow-sm">
            <div className="text-sm text-gray-300">Password Strength: {passwordStrength}</div>
            <div className="mt-2">
